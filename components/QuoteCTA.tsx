  ...
  return (
    <section className="relative bg-white">
      <div className="relative overflow-hidden px-5 py-14 text-center sm:px-8 sm:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(24,119,209,0.1),transparent_60%)]" />
        <motion.p
        ...
        <motion.p
          ...
          className="relative mt-4 text-sm text-slate-500 sm:text-base"
        >
          Or{" "}
          <Link
            href="/contact"
